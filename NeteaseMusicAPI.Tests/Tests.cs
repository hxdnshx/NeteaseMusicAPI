...
namespace NeteaseMusicAPI.Tests
{
    ...
    public class Tests
    {
        ...
        private const int TestNeteaseID = 375540586;//Ëæ±ãÑ¡µÄÒ»¸ö²âÊÔid
        private const int TestSongID = 476081901; //¥«¥¿¥ª¥â¥¤
        private const int TestAlbumID = 3308845; // Bremen
        private const int TestArtistID = 159300; // Ã×½òÐþŽŸ
        ...
        /*
         * "{"logs":"[{\"action\":\"bannerimpress\",\"json\":{\"type\":\"1_¸èÇú\",\"url\":\"/song?id=536570080\",\"id\":\"536570080\",\"position\":3}}]","csrf_token":""}"
         */
        //"daGV1Oz01eIDx8iS"
